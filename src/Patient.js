...
const PatientForm = () => {
  ...
  const fetchPatients = async () => {
    try {
      const response = await axios.get('https://doctorbackend-main-production.up.railway.app/patients');  // Update endpoint URL
  ...
  const fetchDoctors = async () => {
    try {
      const response = await axios.get('https://doctorbackend-main-production.up.railway.app/doctors');  // Update endpoint URL
  ...
  const handleSubmit = async (e) => {
    ...
    axios.post('https://doctorbackend-main-production.up.railway.app/patients', updatedPatientData)
      .then(response => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://doctorbackend-main-production.up.railway.app/patients/${id}`);  // Update endpoint URL
