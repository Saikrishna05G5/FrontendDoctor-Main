...
const PatientForm = () => {
  ...
  const fetchPatients = async () => {
    try {
      const response = await axios.get('http://doctorsproject-env-1.eba-kkdfqd2m.ap-south-1.elasticbeanstalk.com//patients');  // Update endpoint URL
  ...
  const fetchDoctors = async () => {
    try {
      const response = await axios.get('http://doctorsproject-env-1.eba-kkdfqd2m.ap-south-1.elasticbeanstalk.com//doctors');  // Update endpoint URL
  ...
  const handleSubmit = async (e) => {
    ...
    axios.post('http://doctorsproject-env-1.eba-kkdfqd2m.ap-south-1.elasticbeanstalk.com//patients', updatedPatientData)
      .then(response => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://doctorsproject-env-1.eba-kkdfqd2m.ap-south-1.elasticbeanstalk.com//patients/${id}`);  // Update endpoint URL
